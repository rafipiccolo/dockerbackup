...
promisifiedMemoizedMd5OnFilename('g.js').then(console.log).catch(err => console.log('dead'))
promisifiedMemoizedMd5OnFilename('g.js').then(console.log).catch(err => console.log('dead'))
promisifiedMemoizedMd5OnFilename('merge.js').then(console.log).catch(err => console.log('dead'))
